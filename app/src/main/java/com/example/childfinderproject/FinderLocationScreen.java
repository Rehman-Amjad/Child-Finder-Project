...
import com.example.childfinderproject.Model.FinderImage;
...
public class FinderLocationScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check permission
        if (ActivityCompat.checkSelfPermission(FinderLocationScreen.this,
        ...
        else
        {
            ...
            //requst permission
            ActivityCompat.requestPermissions(FinderLocationScreen.this,
            ...
            public void onClick(View v) {
                ...
                imgRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        FinderImage image = new FinderImage(ID,img,lat,lon);
                        imgRef.child(ID).setValue(image);

                        Toast.makeText(FinderLocationScreen.this, "Data Uploaded Successful", Toast.LENGTH_SHORT).show();
                        Intent backIntent = new Intent(FinderLocationScreen.this,FinderMenuScreen.class);
