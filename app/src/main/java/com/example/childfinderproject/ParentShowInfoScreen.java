...
public class ParentShowInfoScreen extends AppCompatActivity {
    ...
    Button btn_parent_face_match,btn_Cam,btn_parent_set_loc,btn_verify,btn_Gallery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_show_info_screen);
        ...
        img_back_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(ParentShowInfoScreen.this,ParentSearchScreen.class);
        ...
        String finderName = preferences.getString("FINDER_NAME","");
        String finderAddress = preferences.getString("FINDER_ADDRESS","");
        String finderPhoneNumber = preferences.getString("FINDER_MOBILE","");
        ...
        img_current.setImageBitmap(decodedImage);



        tv_finderName.setText("Finder Name: " + finderName);
        tv_FinderAddress.setText("Finder Address: " + finderAddress);
        tv_FinderPhone.setText("Finder Phone Number: " + finderPhoneNumber);
        tv_babyName.setText("Baby Name: " + babyName);
        tv_babyAge.setText("Baby Age: " + babyAge);


        if (ContextCompat.checkSelfPermission(ParentShowInfoScreen.this, Manifest.permission.CAMERA)!= PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ParentShowInfoScreen.this, new String[]{
                    Manifest.permission.CAMERA

            }, 100);
        }
        try{
            tflite=new Interpreter(loadmodelfile(ParentShowInfoScreen.this));
        }catch (Exception e) {
            e.printStackTrace();
        }
        ...
        btn_verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(distance<6.0)
                {
                    ...
                    AlertDialog.Builder builder=new AlertDialog.Builder(ParentShowInfoScreen.this);
        ...
        btn_parent_set_loc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent nextIntent = new Intent(ParentShowInfoScreen.this,ParentSetPathMapScreen.class);
