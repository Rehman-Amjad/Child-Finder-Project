...
public class FinderSetMapScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finder_set_map_screen);
        ...
        client = LocationServices.getFusedLocationProviderClient(FinderSetMapScreen.this);

        //check permission
        if (ActivityCompat.checkSelfPermission(FinderSetMapScreen.this,
        ...
        else
        {
            ...
            //requst permission
            ActivityCompat.requestPermissions(FinderSetMapScreen.this,
